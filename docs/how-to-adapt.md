# How to Adapt the Strategic Direction Kit

This guide helps organizations adopt and customize the Strategic Direction Kit for their context.
...
Adopt SDK when:
- The organization needs a governed process for strategic investment decisions
- Multiple strategic bets compete for limited capacity
- Strategic direction currently exists as informal conversations, slides, or tribal knowledge
- IEK feedback loops are producing re-discover signals that need strategic routing

Do not adopt SDK when:
- The organization has a single initiative and no portfolio decisions to make
- Strategic direction is decided externally and simply handed down (use PIK directly)
- The team is small enough that strategic alignment happens naturally
...
- **Capacity units:** The spec does not prescribe how capacity is measured. Use whatever units the organization uses (team-quarters, FTEs, budget dollars, story points).
- **Review triggers:** Add organization-specific triggers (e.g., "major customer churn event", "board strategy revision").

## Integration with Existing Strategic Planning
